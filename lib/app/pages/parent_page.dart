...
class _ParentPageState extends State<ParentPage>
    ...
    return mapScreenState == MapScreenState.Small
        ? Scaffold(
            ...
            floatingActionButton: Showcase(
              ...
              description: 'add_there_new_child_data'.tr,
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      child: Showcase(
                        key: _settingsKey,
                        textColor: Colors.indigo,
                        description: 'change_settings'.tr,
                        showArrow: true,
                        child: Icon(
                          Icons.settings,
                          color: Colors.white,
  ...
  Widget _buildChildrenList(Database database) {
    return Showcase(
      textColor: Colors.indigo,
      description: 'tap_to_see_data'.tr,
      key: _childListKey,
      child: Container(
          decoration: BoxDecoration(
            ...
            builder: (context, snapshot) {
              ...
              if (snapshot.hasData) {
                ...
                return EmptyContent(
                  ...
                  message: 'unable_upload_image'.tr,
                );
              }
              return ListView.builder(
                scrollDirection: Axis.horizontal,
    ...
    return Column(
      ...
      children: <Widget>[
        Padding(
          ...
          child: Text(
            "add_child_location".tr,
            style: TextStyle(color: Colors.indigo),
          ),
        ),
        Text(
          'tap_to_open_full_screen'.tr,
          style: TextStyle(color: Colors.grey.shade400),
        ),
      ],
    ).p16;
