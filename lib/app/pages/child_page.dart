  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: appUsage.info == null
            ? EmptyContent(
                title: 'this_child_page'.tr,
                message: 'nothing_to_show'.tr,
              )
            : Container(
                child: Center(
  ...
  Widget buildNotification() {
    return StreamBuilder<List<NotificationModel>>(
        ...
        builder: (BuildContext context, snapshot) {
                  ...
                  child: Padding(
                    ...
                    child: ListTile(
                      title: Text(data![index].title ??
                          'title_not_available'.tr),
                      trailing: Text(
                        data[index].message ?? 'message_not_available'.tr,
                        style: TextStyle(
          ...
          return EmptyContent(
            message:
                'place_for_all_notifications'.tr,
            title: 'notifications_page'.tr,
            fontSizeMessage: 13,
            fontSizeTitle: 23,
          );
        });
